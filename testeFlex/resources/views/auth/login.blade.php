...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full">
        ...
        <form class="mt-6">
            ...
            <button class="w-full bg-blue-900 text-white py-3 rounded-lg font-bold hover:bg-blue-700 transition">Entar</button>
        </form>
       
        <p class="text-center text-gray-600 mt-4">Não tem uma conta? <a href="{{ url('/auth/register') }}" class="text-blue-900 font-medium">Cadastre-se</a></p>
    </div>
