        ...
        <table class="min-w-full border-collapse border border-gray-300 text-gray-700">
            <thead>
                <tr class="bg-blue-900 text-white">
                    <th class="py-3 px-4 border border-gray-300">Área de Atuação em TI</th>
                    <th class="py-3 px-4 border border-gray-300">Faculdade/Curso Recomendado</th>
                </tr>
            </thead>   
            <tbody>
