...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full">
        <h2 class="text-2xl font-bold text-center text-blue-900">Editar Professor</h2>
        <p class="text-gray-600 text-center mt-2">Preencha os dados abaixo</p>
       
        <form action="../atualizarProfessor/{{$dado->id}}" method="GET" class="mt-6">
            <div class="mb-4">
    ...
    <div id="modal" class="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-75 hidden">
        <div class="bg-white rounded-lg shadow-xl p-6 w-96">
            <h3 class="text-lg font-semibold text-gray-900">Deseja excluir este Professor?</h3>
            ...
            <div class="mt-4 flex justify-end space-x-3">
                ...
                <a class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-500 transition" href="/excluirProfessor/{{$dado->id}}">Excluir</a>
            </div>
        </div>
    </div>
